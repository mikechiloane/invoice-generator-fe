        ...
        <div className="form-container">
            ...
            <div className="space-y-4">
                ...
                <div className="flex justify-end pt-4">
                    <button
                        type="button"
                        className="mr-2 px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-white bg-[var(--secondary)]"
                        onClick={handleClose}
                    >
                        Cancel
                    </button>
                    <button
                        ...
                        className="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[var(--primary)]"
                    >
                        Add Item
                    </button>
                </div>
